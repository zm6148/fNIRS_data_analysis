function fwmodel = genFluenceProfile_brain(fwmodel, probe, iFirst, iLast, headvol, pialsurf, dirnameSubj)
...
[mapMesh2Vox, fwmodel.pialsurf.mesh]  = projVoltoMesh_brain(dirnameSubj, headvol.img, pialsurf, headvol.tiss_prop);
