function [h, l] = displayIntensityOnMesh(mesh, intensity, thresholds, colormin, light_onoff, visible, axes_order)

% Usage:
%
%     [h l] = displayIntensityOnMesh(mesh, intensity, thresholds, light_onoff)
%
% Written by Jay Dubb
%
