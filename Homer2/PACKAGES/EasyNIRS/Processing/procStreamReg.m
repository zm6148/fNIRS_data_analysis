...
'@ hmrMotionCorrectWavelet [dod] (dod,SD iqr %.2f 0.1',...
'@ hmrMotionCorrectPCA #[dod,svsMotion,nSVMotion] (SD,dod,tIncAuto nSV %.2f .8',...
'@ hmrMotionCorrectPCArecurse [dod,tIncAuto,svsmc,nSVmc,tIncAuto0] (dod,t,SD,tIncMan tMotion %0.1f 0.5 tMask %0.1f 1.0 STDEVthresh %0.1f 20.0 AMPthresh %0.2f 5 nSV %.2f 0.97 maxIter %d 5',...
