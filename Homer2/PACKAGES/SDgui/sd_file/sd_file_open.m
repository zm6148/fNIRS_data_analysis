function sd_file_open(filename, pathname, handles)
...
%    end
    ...
    msg=sprintf('Loaded %s from current directory',filename);
    h=uicontrol('style','text','units','pixels','position',[p(1)-20 p(2)-40 300 35],'string',msg);
