...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
# Load the files
setwd("C:\\Users\\mz86\\Desktop\\Fnirs data and analysis\\polynomial using R experiment 3 ITD vs opposite ear - different band each word")
#load("demo_data.RData")
source("code_poly.R")
source("get_pvals.R")

full_data <- read.csv(file=sprintf('C:\\Users\\mz86\\Desktop\\Fnirs data and analysis\\polynomial using R experiment 3 ITD vs opposite ear - different band each word\\R_data_same_soundlevel_HbO.csv'), header=FALSE, sep=",")
