...
for index=1:length(files)
    ...
    if strcmp(name,'TCL_20170206_1039_01')
    ...
    dod = hmrBandpassFilt(dod, t, 0.01, 0.3);
    ...
    save(subject_data_name,'dc_task','s_ITD_task','s_noITD_task','dc','s_b','aux','t','first_task_index','last_task_index', 'dod_raw');
