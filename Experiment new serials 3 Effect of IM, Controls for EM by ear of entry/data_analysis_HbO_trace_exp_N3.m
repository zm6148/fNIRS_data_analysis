...
for index=1:length(files)
    ...
    %dcAvg_subject_ITD_noITD_diff_A = method_substraction_by_b(breath_blockAvg_subject_A, task_blockAvg_subject_A_ITD, task_blockAvg_subject_A_noITD);
    ...
    % ITD no_ITD difference
    %dcAvg_subject_ITD_noITD_diff_B = method_substraction_by_b(breath_blockAvg_subject_B, task_blockAvg_subject_B_ITD, task_blockAvg_subject_B_noITD);
    ...
    % ITD task
    task_blockAvg_subject_E_ITD= hmrBlockAvg(dc_task(:,:,channels_E),s_ITD_task,t,window_t);
    task_blockAvg_subject_E_ITD = method_normalized_by_b( breath_blockAvg_subject_E, task_blockAvg_subject_E_ITD);
    % noITD task
    task_blockAvg_subject_E_noITD = hmrBlockAvg(dc_task(:,:,channels_E),s_noITD_task,t,window_t);
    task_blockAvg_subject_E_noITD = method_normalized_by_b( breath_blockAvg_subject_E, task_blockAvg_subject_E_noITD);
    % ITD no_ITD difference (datapoints * 3)
    %dcAvg_subject_ITD_noITD_diff_C = method_substraction_by_b(breath_blockAvg_subject_C, task_blockAvg_subject_C_ITD, task_blockAvg_subject_C_noITD);
    ...
    % ITD task
    task_blockAvg_subject_F_ITD = hmrBlockAvg(dc_task(:,:,channels_F),s_ITD_task,t,window_t);
    task_blockAvg_subject_F_ITD = method_normalized_by_b( breath_blockAvg_subject_F, task_blockAvg_subject_F_ITD);
    % noITD task
    task_blockAvg_subject_F_noITD = hmrBlockAvg(dc_task(:,:,channels_F),s_noITD_task,t,window_t);
    task_blockAvg_subject_F_noITD = method_normalized_by_b( breath_blockAvg_subject_F, task_blockAvg_subject_F_noITD);
    % ITD no_ITD difference
    %dcAvg_subject_ITD_noITD_diff_D = method_substraction_by_b(breath_blockAvg_subject_D, task_blockAvg_subject_D_ITD, task_blockAvg_subject_D_noITD);
...
%         mean(breath_blockAvg_subject_AB,3));
    ...
    task_blockAvg_subject_ITD = cat (4, mean(task_blockAvg_subject_E_ITD,3), ...
        mean(task_blockAvg_subject_A_ITD,3), ...
        mean(task_blockAvg_subject_F_ITD,3), ...
...
%         mean(task_blockAvg_subject_AB_ITD,3));
    ...
    task_blockAvg_subject_noITD = cat (4, mean(task_blockAvg_subject_E_noITD,3), ...
        mean(task_blockAvg_subject_A_noITD,3), ...
        mean(task_blockAvg_subject_F_noITD,3), ...
...
all_block_p = [];
data_for_R = [];
for ii = 1 : 4 % only plot E, A, F, B size(breath_blockAvg_all,4)
...
% save as cvs
csvwrite('R_data_same_soundlevel_HbO.csv',data_for_R)
