...
%     [ b_AB_breath, r_AB_breath, p_AB_breath] = RCS_breath( dc, s_b, RC_AB, channels_AB  );
    ...
    [ b_E, r_E, p_E] = RCS_ITD_noITD_normalized_by_b( dc, s_b, dc_task, t, window_b, s_ITD_task, s_noITD_task, RC_E, channels_E, Hb_type);
    [ b_A, r_A, p_A] = RCS_ITD_noITD_normalized_by_b( dc, s_b, dc_task, t, window_b, s_ITD_task, s_noITD_task, RC_A, channels_A, Hb_type);
    [ b_F, r_F, p_F] = RCS_ITD_noITD_normalized_by_b( dc, s_b, dc_task, t, window_b, s_ITD_task, s_noITD_task, RC_F, channels_F, Hb_type);
