function [ b, r, p ] = RCS_ITD_noITD_normalized_by_b_onset_time(dc, s_b, dc_task, t, window_b, s_ITD_task, s_noITD_task, RC, channels, Hb_type, onset_time)
...
first_deriv= [0; diff(target_hrf_ITD + target_hrf_noITD)];
...
if strcmp(type,'HbO')
    glm_regressors = cat(2, target_hrf_ITD, target_hrf_noITD, first_deriv, dc_HbO_RC); 
else
    glm_regressors = cat(2, target_hrf_ITD, target_hrf_noITD, first_deriv); %dc_HbO_RC);
end
