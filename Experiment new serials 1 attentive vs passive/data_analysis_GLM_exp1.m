...
channels_E = [11,12,13,15];
channels_A = [1,2,3,5];
channels_F = [16,18,19,20]; %[20, 21, 24, 23];
channels_B = [6,8,9,10]; %[7,  12, 9,  11]];
...
%     s_b_both =  s_b_speech;
    ...
    [ b_C_breath, r_C_breath, p_C_breath] = RCS_breath_catselection( dc_b_both, s_b_both, RC_E, channels_E, Hb_type);
    [ b_A_breath, r_A_breath, p_A_breath] = RCS_breath_catselection( dc_b_both, s_b_both, RC_A, channels_A, Hb_type);
    [ b_D_breath, r_D_breath, p_D_breath] = RCS_breath_catselection( dc_b_both, s_b_both, RC_F, channels_F, Hb_type);
    ...
    [ b_C, r_C, p_C] = RCS_all_stim_cat(  dc_task_both, s_task_speech_both, s_task_SSN_both, RC_E, channels_E, breath_blockAvg_speech, breath_blockAvg_SSN, Hb_type);
    ...
    [ b_D, r_D, p_D] = RCS_all_stim_cat(  dc_task_both, s_task_speech_both, s_task_SSN_both, RC_F, channels_F, breath_blockAvg_speech, breath_blockAvg_SSN, Hb_type);
...
set(gca,'XTickLabel',{'', 'right cIFS', 'left cIFS', 'rigth STG', 'left STG',''});
set(gca,'TickDir','out');
