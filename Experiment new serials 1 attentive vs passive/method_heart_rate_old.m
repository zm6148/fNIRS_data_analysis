function [HRV_blvg] = method_heart_rate(dod_raw, s_task, t, window_t, window_size)
...
to_inter = numincell;
x2 = 1:size(to_inter,2); 
xq2 = linspace(1,size(to_inter,2),size(to_inter,2)*samplesPerBlock);
