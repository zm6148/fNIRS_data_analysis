...
for index=1:length(files)
    ...
    % mean heart rate
    [mean_heartrate_at_C, pks, locs] = method_heart_rate_v2(dod_raw, s_task, t, window_h, window_size);
    ...
    % mean heart rate
    mean_heartrate_at_A = method_heart_rate_v2(dod_raw, s_task, t, window_h, window_size);
    ...
    % mean heart rate
    mean_heartrate_at_D = method_heart_rate_v2(dod_raw, s_task, t, window_h, window_size);
    ...
    % mean heart rate
    mean_heartrate_at_B = method_heart_rate_v2(dod_raw, s_task, t, window_h, window_size);
