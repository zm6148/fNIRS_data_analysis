...
filename_path = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\data\\blvg_trace exp1\\combined_answer\\combined_answer.mat'
...
answer_sheet = mat_answer['AB_answer_sheet']
...
for filename in os.listdir(dirname):
    ...
    for n in range(0,repeat_num):
        ...
        for i in range(0, 10, 1):
            ...
            clf_nn = MLPClassifier(solver='lbfgs', activation='logistic', hidden_layer_sizes=(20,15,5),random_state=r,max_iter=1000)
            clf_nn.fit(X,y)
        ...
        clf_nn = MLPClassifier(solver='lbfgs', activation='logistic', hidden_layer_sizes=(20,15,5),random_state=6293697,max_iter=1000)
        clf_nn.fit(X,y)
        ...
        path  = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\trained_classifier_for_combined_regions\\' + site_name + '\\'+ str(n);
        try: 
            os.makedirs(path)
        except OSError:
...
np.save('C:\\Users\\mz86\Desktop\\fNIRS ML\\trained_classifier_for_combined_regions' +'\\accuracy.npy', four_sit_result_nn)
# save the best lose for later
np.save('C:\\Users\\mz86\Desktop\\fNIRS ML\\trained_classifier_for_combined_regions' +'\\loss.npy', four_sit_loss)

    
print ('SVM:')  
###############################################################################################
print ('AB: ' + str(np.mean(four_sit_result[0])) + ' std: ' + str(np.std(four_sit_result[2])))
print ('CA: ' + str(np.mean(four_sit_result[1])) + ' std: ' + str(np.std(four_sit_result[0])))
print ('CD: ' + str(np.mean(four_sit_result[2])) + ' std: ' + str(np.std(four_sit_result[3])))
print ('DB: ' + str(np.mean(four_sit_result[3])) + ' std: ' + str(np.std(four_sit_result[1])))
###############################################################################################
print ('DT:')
###############################################################################################
print ('AB: ' + str(np.mean(four_sit_result_DT[0])) + ' std: ' + str(np.std(four_sit_result_DT[2])))
print ('CA: ' + str(np.mean(four_sit_result_DT[1])) + ' std: ' + str(np.std(four_sit_result_DT[0])))
print ('CD: ' + str(np.mean(four_sit_result_DT[2])) + ' std: ' + str(np.std(four_sit_result_DT[3])))
print ('DB: ' + str(np.mean(four_sit_result_DT[3])) + ' std: ' + str(np.std(four_sit_result_DT[1])))
###############################################################################################
print ('nn:')
###############################################################################################
print ('AB: ' + str(np.mean(four_sit_result_nn[0])) + ' std: ' + str(np.std(four_sit_result_nn[2])))
print ('CA: ' + str(np.mean(four_sit_result_nn[1])) + ' std: ' + str(np.std(four_sit_result_nn[0])))
print ('CD: ' + str(np.mean(four_sit_result_nn[2])) + ' std: ' + str(np.std(four_sit_result_nn[3])))
print ('DB: ' + str(np.mean(four_sit_result_nn[3])) + ' std: ' + str(np.std(four_sit_result_nn[1])))
