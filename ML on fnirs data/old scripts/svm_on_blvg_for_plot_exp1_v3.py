...
for filename in os.listdir(dirname):
    ...
    for n in range(0,repeat_num):
        ...
        for i in range(0, 10, 1):
            ...
            clf_nn = MLPClassifier(solver='lbfgs', activation='logistic', hidden_layer_sizes=(15,5),random_state=r,max_iter=1000)
            clf_nn.fit(X,y)
        ...
        clf_nn = MLPClassifier(solver='lbfgs', activation='logistic', hidden_layer_sizes=(15,5),random_state=bestseed,max_iter=1000)
        clf_nn.fit(X,y)
