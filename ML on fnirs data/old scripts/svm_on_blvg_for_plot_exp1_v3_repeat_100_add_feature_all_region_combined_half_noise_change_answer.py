...
filename_path = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\data\\blvg_trace exp1\\combined_all_noise_answer\\C_noise_answer_sheet.mat'
#filename_path = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\data\\blvg_trace exp2\\answer\\answer_sheet.mat'
mat_answer = scipy.io.loadmat(filename_path)
answer_sheet_CA = mat_answer['C_noise_answer_sheet']

# DB combined answer sheet
filename_path = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\data\\blvg_trace exp1\\combined_all_noise_answer\\D_noise_answer_sheet.mat'
#filename_path = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\data\\blvg_trace exp2\\answer\\answer_sheet.mat'
mat_answer = scipy.io.loadmat(filename_path)
answer_sheet_DB = mat_answer['D_noise_answer_sheet']
...
jj_path = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\trained_classifiers\\100_exp1_MNN_with_all_region_half_noise_change_answersheet'
...
for jj in range(0,1):
    ...
    for filename in os.listdir(dirname):
        ...
        elif filename == 'C_noise_matrix.mat':
            answer_sheet = answer_sheet_CA;
            region_matrix = CA_region_matrix  
            # Do the other thing
        elif filename == 'D_noise_matrix.mat':
...
print ('nn:')
###############################################################################################
print ('CA: ' + str(np.mean(four_sit_result_nn[0])) + ' std: ' + str(np.std(four_sit_result_nn[0])))
print ('DB: ' + str(np.mean(four_sit_result_nn[1])) + ' std: ' + str(np.std(four_sit_result_nn[1])))
