...
for filename in os.listdir(dirname):
    ...
    for n in range(0,repeat_num):
        ...
        path  = 'C:\\Users\\mz86\\Desktop\\fNIRS ML\\trained_classifiers\\' + site_name + '\\'+ str(n);
        try: 
            os.makedirs(path)
        except OSError:
...
np.save('C:\\Users\\mz86\Desktop\\fNIRS ML\\trained_classifiers' +'\\accuracy.npy', four_sit_result_nn)
# save the best lose for later
np.save('C:\\Users\\mz86\Desktop\\fNIRS ML\\trained_classifiers' +'\\loss.npy', four_sit_loss)
