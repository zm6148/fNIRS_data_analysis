...
# R_STG
full_data <- read.csv(file="C:/Users/mz86/Desktop/Fnirs data and analysis/fnirs_R_analysis_antje_using_d_prime experiment new 3/ITD vs opposite redo same band per-block - R_STG_HbO.csv",header = TRUE,sep=",")  
...
# L_STG
full_data2 <- read.csv(file="C:/Users/mz86/Desktop/Fnirs data and analysis/fnirs_R_analysis_antje_using_d_prime experiment new 3/ITD vs opposite redo same band per-block - L_STG_HbO.csv",header = TRUE,sep=",")  
...
# R_cIFS
full_data3 <- read.csv(file="C:/Users/mz86/Desktop/Fnirs data and analysis/fnirs_R_analysis_antje_using_d_prime experiment new 3/ITD vs opposite redo same band per-block - R_cIFS_HbO.csv",header = TRUE,sep=",")  
...
#L_cIFS
full_data4 <- read.csv(file="C:/Users/mz86/Desktop/Fnirs data and analysis/fnirs_R_analysis_antje_using_d_prime experiment new 3/ITD vs opposite redo same band per-block - L_cIFS_HbO.csv",header = TRUE,sep=",")  
